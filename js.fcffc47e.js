...
var underMain = document.getElementById('mainUnder');
var mainTimeContainer = document.getElementById('mainTimeContainer');
...
var date = new Date('jun 11 2023 18:00:00');
function counts() {
  var now = new Date();
  gap = date - now;
...
var buttons = document.querySelectorAll('.buttonAccardion');
